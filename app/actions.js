...
export async function addProduct(formData) {
    ...
    try {
        ...
        // if product already exists, update it, otherwise insert a new record
        const { data: existingProduct } = await supabase
            .from("products")
            .select("id, current_price") //fetching data from db in supabase
            .eq("user_id", user.id) // checking if the user has already added this product by matching the url
            .eq("url", url)
            .single()
